...
// Registry define a service registry.
type Registry interface {
	// Register creates a service instance record in
	// registry.
	Register(ctx context.Context, instanceId string,
		serviceName string, hostPort string) error
	// Deregister removes a service insttane record from
	//the registry
	...
	ServicesAddresses(ctx context.Context, instanceID string) ([]string, error)
